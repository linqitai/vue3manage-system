	...
	<div class="table">
		...
		<div class="container">
			...
			<el-table :data="tableData" border stripe class="table" ref="multipleTable" style="width: 100%">
				...
				<el-table-column prop="date" label="买家手机号" width="150"></el-table-column>
				<el-table-column prop="date" label="卖家ID" width="150"></el-table-column>
				<el-table-column prop="date" label="卖家手机号" width="150"></el-table-column>
				<el-table-column prop="date" label="交易类型" width="150"></el-table-column>
				<el-table-column prop="date" label="交易数量" width="150"></el-table-column>
				<el-table-column prop="date" label="交易单价" width="150"></el-table-column>
				<el-table-column prop="date" label="挂单时间" width="150"></el-table-column>
				
				<el-table-column prop="role" label="放币时间" width="120"></el-table-column>
				<el-table-column prop="pic" label="付款截图" width="120"></el-table-column>
				<el-table-column label="备注" width="200">
					<template slot-scope="props">
						<span class="ellipsis">{{ props.row.remark }}</span>
					</template>
				</el-table-column>
				<el-table-column prop="name" label="匹配时间" width="120" fixed="right"></el-table-column>
				<el-table-column prop="date" label="交易状态" width="100" fixed="right"></el-table-column>
