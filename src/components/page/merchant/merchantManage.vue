<template>
	<div class="table">
		...
		<div class="container">
			...
			<el-table :data="tableData" border stripe class="table" show-summary ref="multipleTable" style="width: 100%">
				<el-table-column prop="ID" label="商家ID" width="80"></el-table-column>
				<!-- <el-table-column prop="date" label="日期"  width="120"></el-table-column> -->
				<el-table-column prop="date" label="商家姓名" width="150"></el-table-column>
				<el-table-column prop="phone" label="商家手机号" width="120"></el-table-column>
				<el-table-column prop="coupon" label="交易单数"></el-table-column>
				<el-table-column prop="coupon" label="营业额"></el-table-column>
				<el-table-column prop="coupon" label="纯利润"></el-table-column>
				<el-table-column prop="coupon" label="贡献平台券"></el-table-column>
