		...
		<div class="container">
			<search-condition @clickSearchData="searchEvent">
				...
				<div class="element">
					<p class="inline">类型</p>
					<div class="inline">
						<el-select v-model="searchForm.type" @change="typeChange" class="handle-select mr10 width120">
			...
			<el-table :data="tableData" border stripe class="table" ref="multipleTable" style="width: 100%">
				<el-table-column prop="ID" label="流通ID" min-width="100"></el-table-column>
				<el-table-column prop="ID" label="账本ID" min-width="100"></el-table-column>
				<el-table-column prop="ID" label="矿石ID" min-width="120"></el-table-column>
				<el-table-column prop="ID" label="fromUserID" min-width="120"></el-table-column>
				<el-table-column prop="date" label="toUserID" min-width="120"></el-table-column>
				...
				<el-table-column prop="date" label="矿石" min-width="100"></el-table-column>
